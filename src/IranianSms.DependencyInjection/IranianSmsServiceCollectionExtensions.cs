...
namespace IranianSms.DependencyInjection
{
    /// <summary>
    ...
    /// </summary>
    public static class IranianSmsServiceCollectionExtensions
    {
        /// <summary>
        ...
        public static IServiceCollection AddIranianSms<TClient>(this IServiceCollection services, TClient instance)
