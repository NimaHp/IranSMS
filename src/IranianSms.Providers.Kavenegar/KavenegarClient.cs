using IranianSms.Providers.Kavenegar.Json;
...
namespace IranianSms.Providers.Kavenegar
{
    ...
    public sealed class KavenegarClient : ISmsClient, ISmsBulkSender, ISmsOtpSender, ISmsDeliveryReporter
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            {
                throw new IranianSmsException("Kavenegar returned a malformed response.", ex)
                {
            ...
            {
                throw new IranianSmsException("Kavenegar returned an empty envelope.")
                {
                    ProviderName = ProviderName,
                    RawResponseBody = body,
                };
